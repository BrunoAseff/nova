          ...
          >
            {ambientSounds.map((sound) => {
              ...
              return (
                <label
                  key={sound.name}
                  className={`relative z-50 flex h-[5rem] w-[6.3rem] cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border-[1px] border-muted bg-accent-foreground text-center shadow-sm ring-offset-background transition-all duration-300 ${
                    isChecked
