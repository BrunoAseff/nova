...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "data-[state=open]:bg-secondary-smooth-700/10 flex h-10 w-full items-center justify-between rounded-2xl border-[1px] border-accent bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[state=open]:border-secondary [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
