...
export default function ClockTab() {
  ...
  return (
    <main className="h-screen">
      ...
      />
      <div className="scrollbar-thin scrollbar-gutter-stable sm-min-w-full scrollbar-track-background scrollbar-thumb-accent mt-[7.2rem] h-[calc(100vh-190px)] w-[140%] flex-col gap-6 space-y-4 overflow-y-auto pb-10 pr-6 md:h-[calc(100vh-250px)] md:w-[110%]">
        {" "}
