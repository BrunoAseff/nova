    ...
    persist(
          ...
          set((state) => {
            ...
            if (state.currentTab === "Focus") {
              ...
              return {
                ...
                currentTab:
                  newCycleCounter === 0 ? "Long Break" : "Short Break",
                amountSecondsPassed: 0,
                isPaused: false,
              };
            }
      ...
      }),
      {
        ...
        partialize: (state: CycleStore) => ({
          ...
          isPaused: state.isPaused,
          focusingOnMessage: state.focusingOnMessage,
          cycleCounter: state.cycleCounter,
          completedCycles: state.completedCycles,
          startTime: state.startTime,
          focusedTime: state.focusedTime,
          breakTime: state.breakTime,
          focusedTimeStat: state.focusedTimeStat,
          breakTimeStat: state.breakTimeStat,
          overallTimeStat: state.overallTimeStat,
          initialStartTime: state.initialStartTime,
        }),
      },
    ),
